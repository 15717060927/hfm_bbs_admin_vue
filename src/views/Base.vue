    ...
    <el-container>
      ...
      <el-main style="padding-top: 5px;">
        ...
        <div class="search-wrapper">
          ...
          <el-input v-model="uname" class="input-with-select" placeholder="请输入用户名">
            <el-select slot="prepend" v-model="select" placeholder="请选择">
              <el-option label="餐厅名" value="1"></el-option>
              <el-option label="订单 号" value="2"></el-option>
              <el-option label="用户电话" value="3"></el-option>
            </el-select>
            <el-button slot="append" icon="el-icon-search" style="color:dodgerblue" type="primary"
        ...
        <div class="btn-group">
          ...
          <el-button type="primary" @click="handleInsert">新增<i class="el-icon-circle-plus-outline"
                                                               style="margin-left:5px"></i></el-button>
          <el-button type="primary" @click=" delBatch">批量删除<i class="el-icon-delete" style="margin-left:5px"></i>
          </el-button>
        </div>
        ...
        <el-table :data="tableData" border @selection-change="handleSelectionChange">
          ...
          <el-table-column label="姓名" prop="uname" width="140">
          </el-table-column>
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <!--scope.row获取当前的数据对象 -->
              <el-button size="medium" type="success" @click="handleEdit(scope.row)">编辑<i class="el-icon-edit"
              ...
              >
                <el-button slot="reference" size="medium" type="danger">删除<i class="el-icon-delete"></i></el-button>
              </el-popconfirm>
            </template>
          </el-table-column>
        </el-table>
